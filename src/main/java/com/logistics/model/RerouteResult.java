...
public class RerouteResult {
    ...
    public RerouteResult(String shipmentId, List<String> originalPath,
                         List<String> newPath, double oldCost, double newCost) {
    ...
    public String getId()                    { return shipmentId; }
    public List<String> getOriginalPath()    { return originalPath; }
    public List<String> getPath()            { return newPath; }
